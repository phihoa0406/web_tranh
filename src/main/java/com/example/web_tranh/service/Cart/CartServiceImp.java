...
public class CartServiceImp implements CartService{
    ...
    public ResponseEntity<?> save(JsonNode jsonData)
    {
        try {
            int idUser = 0;
            // Danh tranh item của data vừa truyền
            ...
            for (CartItem cartItemData : cartItemDataList) {
                ...
                for (CartItem cartItem : cartItemList) {
                    ...
                    if (cartItem.getArt().getIdArt() == cartItemData.getArt().getIdArt()) {
                ...
                if (!isHad) {
                    ...
                    cartItem.setArt(cartItemData.getArt());
